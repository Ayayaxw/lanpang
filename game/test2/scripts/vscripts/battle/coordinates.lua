...
--主要角斗场
Main.largeSpawnCenter = Vector(150, 150, 141)
Main.largeSpawnArea = Vector(100, 500, 141)
Main.largeSpawnArea_Caipan = Vector(144.5, 1600, 0)
Main.largeSpawnArea_northWest = Vector(-1587, 1300, 141)
Main.largeSpawnArea_northEast = Vector(1850, 1300, 141)
Main.largeSpawnArea_southWest = Vector(1850, -800, 141)
Main.largeSpawnArea_southEast = Vector(-1587, -800, 141)
...
--瀑布角斗场
Main.waterFall_Center = Vector(-6000, 120, 128)
Main.waterFall_Left = Vector(-6660, 90, 128)
Main.waterFall_Right  = Vector(-5460, 90, 128)
Main.waterFall_NorthWest = Vector(-7211, 1316, 256)
Main.waterFall_SouthEast = Vector(-7211, 1316, 256)
Main.waterFall_Caipan = Vector(-6015, 1489, 256)
