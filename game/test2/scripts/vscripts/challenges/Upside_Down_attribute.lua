function Main:Cleanup_Upside_Down_attribute()

end

function Main:Init_Upside_Down_attribute(event, playerID)
    -- 技能修改器
...
function Main:OnUnitKilled_Upside_Down_attribute(killedUnit, args)
