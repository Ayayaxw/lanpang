...
LinkLuaModifier("modifier_health_regen_custom", "modifier/modifier_health_regen_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_mana_regen_custom", "modifier/modifier_mana_regen_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_air_spin_controller", "modifier/modifier_air_spin_controller.lua", LUA_MODIFIER_MOTION_BOTH)
--添加LUA_MODIFIER_MOTION_BOTH这种modifier的时候，需要完全重启编辑器才能生效
LinkLuaModifier("modifier_mounted", "modifier/modifier_mounted.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_auto_walrus_punch", "modifier/modifier_auto_walrus_punch.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_kv_editor_specific_ability", "modifier/modifier_kv_editor_specific_ability.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_attack_cast_ability_Any", "modifier/modifier_attack_cast_ability_Any.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_allow_all_pathing", "modifier/modifier_allow_all_pathing.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_auto_walrus_punch_custom", "modifier/modifier_auto_walrus_punch_custom.lua", LUA_MODIFIER_MOTION_NONE)