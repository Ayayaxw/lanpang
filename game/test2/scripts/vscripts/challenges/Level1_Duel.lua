function Main:Cleanup_Level1_Duel()

end

function Main:Init_Level1_Duel(event, playerID)
    -- 技能修改器
...
function Main:OnUnitKilled_Level1_Duel(killedUnit, args)
...
function Main:OnNPCSpawned_Level1_Duel(spawnedUnit, event)
    -- 如果不是被排除的单位，则应用战场效果
