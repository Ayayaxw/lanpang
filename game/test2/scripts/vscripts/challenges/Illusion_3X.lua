function Main:Cleanup_Illusion_3X()

end

function Main:Init_Illusion_3X(event, playerID)
    -- 技能修改器
    ...
    self.HERO_CONFIG = {
        ...
        ENEMY = {
            function(hero)
                ...
                HeroMaxLevel(hero)
                hero:AddItemByName("item_attribute_amplifier_3x")
...
function Main:OnUnitKilled_Illusion_3X(killedUnit, args)
...
function Main:OnNPCSpawned_Illusion_3X(spawnedUnit, event)
    -- 如果不是被排除的单位，则应用战场效果
