...
function CommonAI:Ini_DisabledSkills()
    self.disabledSkills = {
        ...
        npc_dota_hero_dawnbreaker = { "dawnbreaker_land",},
        npc_dota_hero_doom_bringer = {"doom_bringer_devour"},
        npc_dota_hero_shredder = {},
        npc_dota_hero_kunkka = {"kunkka_return"},
        npc_dota_hero_life_stealer = {"life_stealer_consume","life_stealer_infest"},
        ...
        npc_dota_hero_abyssal_underlord = {"abyssal_underlord_dark_portal"},
        npc_dota_hero_sven = {"sven_gods_strength"},
        npc_dota_hero_legion_commander = {"legion_commander_duel","legion_commander_press_the_attack"},
