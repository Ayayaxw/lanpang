function Main:Cleanup_CD0_1skill()

end

function Main:Init_CD0_1skill(event, playerID)
    -- 技能修改器
    ...
    self.HERO_CONFIG = {
        ...
        BATTLEFIELD = {
            function(hero)
                hero:AddNewModifier(hero, nil, "modifier_no_cooldown_FirstSkill", {})
...
function Main:OnUnitKilled_CD0_1skill(killedUnit, args)
...
function Main:OnNPCSpawned_CD0_1skill(spawnedUnit, event)
    -- 如果不是被排除的单位，则应用战场效果
