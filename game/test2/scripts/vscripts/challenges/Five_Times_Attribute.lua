function Main:Cleanup_Five_Times_Attribute()

end

function Main:Init_Five_Times_Attribute(event, playerID)
    -- 技能修改器
    ...
    self.limitTime = 90        -- 限定时间为准备时间结束后的一分钟
...
function Main:OnUnitKilled_Five_Times_Attribute(killedUnit, args)
...
function Main:OnNPCSpawned_Five_Times_Attribute(spawnedUnit, event)
    -- 如果不是被排除的单位，则应用战场效果
