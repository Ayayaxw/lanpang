function Main:Cleanup_DeathRandom()

end

function Main:Init_DeathRandom(event, playerID)
    -- 技能修改器
...
function Main:OnUnitKilled_DeathRandom(killedUnit, args)
...
function Main:OnNPCSpawned_DeathRandom(spawnedUnit, event)
    -- 如果不是被排除的单位，则应用战场效果
