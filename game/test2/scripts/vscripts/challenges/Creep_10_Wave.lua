function Main:Init_Creep_10_Wave(event, playerID)
    -- 1. 基础参数初始化
...
function Main:OnUnitKilled_Creep_10_Wave(killedUnit, args)
...
-- NPC生成时应用战场配置
function Main:OnNPCSpawned_Creep_10_Wave(spawnedUnit, event)
